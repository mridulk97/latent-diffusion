...
npz_output_file = '/fastscratch/mridul/ldm/samples/CW_f8_scale1_steps20_epoch224.npz'
dir_path = '/fastscratch/mridul/ldm/samples/CW_f8_scale1_steps20_epoch224'
...
for class_label in classes:
    for i in range(n_samples_per_class):
        ...
        Image.fromarray(img_arr).save(f'{dir_path}/image_{i}_{label_to_class_mapping[class_label]}.png')
