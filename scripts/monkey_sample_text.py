...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        # default=5.0,
        default='/fastscratch/mridul/new_diffusion_models/ldm/cub_conditioning/2023-12-12T18-19-11_BERT_f4_epoch185_batch8/configs/2023-12-12T18-19-11-project.yaml',
    ...
    parser.add_argument(
        ...
        type=str,
        # default=5.0,
        default='/fastscratch/mridul/new_diffusion_models/ldm/cub_conditioning/2023-12-12T18-19-11_BERT_f4_epoch185_batch8/checkpoints/epoch=000140.ckpt',
    ...
    #     class_to_node = '/projects/ml4science/mridul/ldm/data/cub/cub_to_scientific.pkl'
        ...
        class_to_node = '/projects/ml4science/mridul/data/monkeys_dataset/monkey_HLE_labels.pkl'
